...
using Mersus.Core.Repositories;
...
using Mersus.Core.DataAccess.Repositories;

namespace Mersus.WebUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<MersusContext>(item => item.UseSqlServer(Configuration.GetConnectionString("MersusDatabase")));
